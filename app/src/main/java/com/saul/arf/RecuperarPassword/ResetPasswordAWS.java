...
public class ResetPasswordAWS extends AsyncTask<Void,Void,String> {
    ...
    public ResetPasswordAWS(Context context, String urlAws, String typeAws, String email, String code, String pass){
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            paramsPost.put("code",this.getCodigo());
            ...
            if ( urlConnection.getResponseCode() == HttpsURLConnection.HTTP_OK) {
                ...
                while ((renglon = in.readLine()) != null) {
                    ...
                    ResetActivity.setRequest_code_aws(code);
