...
public class ObtenerCodigoAWS extends AsyncTask<Void,Void,String> {
    ...
    public ObtenerCodigoAWS(Context context, String urlAws, String codigoRecuperacion, String correo, String typeAws) {
        this.setCodigo_recuperacion(codigoRecuperacion);
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            paramsPost.put("code", this.getCodigo_recuperacion());
            ...
            if (urlConnection.getResponseCode() == HttpsURLConnection.HTTP_OK) {
                ...
                while ((renglon = in.readLine()) != null) {
                    ...
                    System.out.println("JSONREQUEST: "+mensaje+" "+code);
                    break;
                }
                in.close();
